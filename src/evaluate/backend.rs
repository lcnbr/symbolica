...
mod native_load {
    ...
    pub(super) type EvalTypeWithBuffer<'a, T> =
        libloading::Symbol<'a, unsafe extern "C" fn(params: *const T, buffer: *mut T, out: *mut T)>;
    pub(super) type CudaEvalType<'a, T> = libloading::Symbol<
        'a,
        unsafe extern "C" fn(params: *const T, out: *mut T, data: *const CudaEvaluationData),
    >;
    pub(super) type CudaInitDataType<'a> = libloading::Symbol<
        'a,
        unsafe extern "C" fn(n: usize, block_size: usize) -> *const CudaEvaluationData,
    >;
    pub(super) type CudaDestroyDataType<'a> =
        libloading::Symbol<'a, unsafe extern "C" fn(data: *const CudaEvaluationData) -> i32>;
    pub(super) type GetBufferLenType<'a> =
        libloading::Symbol<'a, unsafe extern "C" fn() -> c_ulong>;

    pub(super) struct EvaluatorFunctionsRealf64<'lib> {
        pub(super) eval: EvalTypeWithBuffer<'lib, f64>,
        pub(super) get_buffer_len: GetBufferLenType<'lib>,
    }
    ...
    pub(super) type L = std::sync::Arc<libloading::Library>;

    self_cell!(
        pub(super) struct LibraryRealf64 {
            owner: L,
    ...
    pub(super) struct EvaluatorFunctionsSimdRealf64<'lib> {
        pub(super) eval: EvalTypeWithBuffer<'lib, wide::f64x4>,
        pub(super) get_buffer_len: GetBufferLenType<'lib>,
    }
    ...
    self_cell!(
        pub(super) struct LibrarySimdComplexf64 {
            owner: L,
    ...
    pub(super) struct EvaluatorFunctionsSimdComplexf64<'lib> {
        pub(super) eval: EvalTypeWithBuffer<'lib, Complex<wide::f64x4>>,
        pub(super) get_buffer_len: GetBufferLenType<'lib>,
    }
    ...
    self_cell!(
        pub(super) struct LibrarySimdRealf64 {
            owner: L,
    ...
    pub(super) struct EvaluatorFunctionsComplexf64<'lib> {
        pub(super) eval: EvalTypeWithBuffer<'lib, Complex<f64>>,
        pub(super) get_buffer_len: GetBufferLenType<'lib>,
    }
    ...
    self_cell!(
        pub(super) struct LibraryComplexf64 {
            owner: L,
    ...
    pub(super) struct EvaluatorFunctionsCudaRealf64<'lib> {
        pub(super) eval: CudaEvalType<'lib, f64>,
        pub(super) init_data: CudaInitDataType<'lib>,
        pub(super) destroy_data: CudaDestroyDataType<'lib>,
    }
    ...
    self_cell!(
        pub(super) struct LibraryCudaRealf64 {
            owner: L,
    ...
    pub(super) struct EvaluatorFunctionsCudaComplexf64<'lib> {
        pub(super) eval: CudaEvalType<'lib, Complex<f64>>,
        pub(super) init_data: CudaInitDataType<'lib>,
        pub(super) destroy_data: CudaDestroyDataType<'lib>,
    }
    ...
    self_cell!(
        pub(super) struct LibraryCudaComplexf64 {
            owner: L,
...
mod jit {
    ...
    #[cfg(feature = "serde")]
    impl<'de, T: JITCompiledNumber + EvaluationDomain + symjit::Element + Copy>
...
mod compiled_native {
    ...
    impl CompiledNumber for f64 {
        ...
        fn export_cpp<T: ExportNumber + SingleFloat>(
            ...
            Ok(match settings.inline_asm {
                ...
                InlineASM::None => {
                    let r =
                        eval.export_generic_cpp_str(function_name, &settings, NumberClass::RealF64);
    ...
    impl CompiledNumber for Complex<f64> {
        ...
        fn export_cpp<T: ExportNumber + SingleFloat>(
            ...
            Ok(match settings.inline_asm {
                ...
                InlineASM::None => {
                    let r = eval.export_generic_cpp_str(
                        function_name,
                        &settings,
    ...
    impl CompiledNumber for wide::f64x4 {
        ...
        fn export_cpp<T: ExportNumber + SingleFloat>(
            ...
            Ok(match settings.inline_asm {
                // assume AVX2 for X64
                InlineASM::X64 => {
                    eval.export_simd_str(function_name, settings, false, InlineASM::AVX2)
                }
                InlineASM::AArch64 => {
    ...
    impl CompiledSimdRealEvaluator {
        pub fn load_new_function(
            ...
            let library =
                LibrarySimdRealf64::try_new(self.library.borrow_owner().clone(), |lib| {
    ...
    impl CompiledNumber for Complex<wide::f64x4> {
        ...
        fn export_cpp<T: ExportNumber + SingleFloat>(
            ...
            Ok(match settings.inline_asm {
                // assume AVX2 for X64
                InlineASM::X64 => {
                    eval.export_simd_str(function_name, settings, true, InlineASM::AVX2)
                }
                InlineASM::AArch64 => {
    ...
    impl CompiledSimdComplexEvaluator {
        pub fn load_new_function(
            ...
            let library =
                LibrarySimdComplexf64::try_new(self.library.borrow_owner().clone(), |lib| {
    ...
    impl CompiledCudaRealEvaluator {
        pub fn load_new_function(
            ...
            let library =
                LibraryCudaRealf64::try_new(self.library.borrow_owner().clone(), |lib| {
    ...
    impl CompiledCudaComplexEvaluator {
        pub fn load_new_function(
            ...
            let library =
                LibraryCudaComplexf64::try_new(self.library.borrow_owner().clone(), |lib| {
